...
namespace BasketApi
{
    public static class Utility
    {
        ...
        public static async Task GenerateToken(this User user, HttpRequestMessage request,int? IsRegister=0)
        {
            try
            {
                var parameters = new Dictionary<string, string>{
                            ...
                            {"NewRegister",IsRegister.ToString() }
                        };
        ...
        public static async Task GenerateToken(this Admin user, HttpRequestMessage request,int? IsRegister=0)
        {
            try
            {
                var parameters = new Dictionary<string, string>{
        ...
        public enum AivoBotEntityTypes
        {
            Admin,
            Franchise,
            Settings,
