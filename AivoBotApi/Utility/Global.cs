...
namespace BasketApi
{
    public static class Global
    {
        ...
        public enum AnsweringCallStatus
        {
            [Display(Name = "No One Heard")]
            NoOneHeard = 0,

            [Display(Name = "MissedAnswer HangUp ShutDown or Arrears")]
            MissedAnswerHangUpShutDownArrears = 1,

        }
        public enum CallStatuses
        {
            [Display(Name = "Not Part of The Calling Plan")]
            NoPlan = 0,
